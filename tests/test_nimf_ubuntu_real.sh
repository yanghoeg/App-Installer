...
# 사용법: bash app-installer/tests/test_nimf_ubuntu_real.sh  (또는 app-installer repo 루트에서 bash tests/test_nimf_ubuntu_real.sh)
# 주의: 실기기(Termux + proot-distro) 전용 — 단위 테스트 스위트에 포함하지 말 것.
# =============================================================================
set -uo pipefail
